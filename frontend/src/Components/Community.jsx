        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col items-center text-center relative">
            ...
            <div className="mb-4">
              ...
              <a href="https://discord.com/invite/code" className="block underline hover:text-cyan-500 mb-2 flex items-center">
              ...
              <a href="https://discord.com/invite/tccpp" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaDiscord className="mr-2 text-blue-500" /> Together C and C++
              </a>
              <a href="https://discord.com/invite/python" className="block underline hover:text-cyan-500 mb-2 flex items-center">
              ...
              <a href="https://discord.com/invite/WDrH3zuWFb" className="block underline hover:text-cyan-500 mb-2 flex items-center">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col items-center text-center relative">
            ...
            <div className="mb-4">
              <a href="https://www.reddit.com/r/webdevelopment/" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaReddit className="mr-2 text-red-500" /> Web Development
              </a>
              <a href="https://www.reddit.com/r/programming/" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaReddit className="mr-2 text-red-500" /> Programming
              </a>
              <a href="https://www.reddit.com/r/learnmachinelearning/" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaReddit className="mr-2 text-red-500" /> Machine Learning
              </a>
              <a href="https://www.reddit.com/r/devops/" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaReddit className="mr-2 text-red-500" /> DevOps
              </a>
              <a href="https://www.reddit.com/r/SideProject/" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaReddit className="mr-2 text-red-500" /> SideProject
              </a>
              <a href="https://www.reddit.com/r/developersIndia/" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaReddit className="mr-2 text-red-500" /> Developers India
              </a>
              <a href="https://www.reddit.com/r/ProgrammerHumor/" className="block underline hover:text-cyan-500 mb-2 flex items-center">
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col items-center text-center relative">
            ...
            <div className="mb-4">
              <a href="https://x.com/codenewbies" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaTwitter className="mr-2 text-blue-400" /> CodeNewbies
              </a>
              <a href="https://x.com/gitconnected" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaTwitter className="mr-2 text-blue-400" /> Developer Community
              </a>
              <a href="https://x.com/indianswhocode" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaTwitter className="mr-2 text-blue-400" /> Indianswhocode
              </a>
              <a href="https://x.com/taskonxyz" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaTwitter className="mr-2 text-blue-400" /> Web3 Community
              </a>
              <a href="https://x.com/cryptooindia" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaTwitter className="mr-2 text-blue-400" /> Crypto India
              </a>
              <a href="https://x.com/i/communities/1699807431709041070" className="block underline hover:text-cyan-500 mb-2 flex items-center">
                <FaTwitter className="mr-2 text-blue-400" /> Software Developer
              </a>
              <a href="https://x.com/DataSciFact" className="block underline hover:text-cyan-500 mb-2 flex items-center">
