    ...
    <div id="roadmap" className="bg-black text-white min-h-screen flex flex-col items-center justify-center pt-24 lg:pt-0 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-4xl mx-auto relative z-20">
        {boxData.map((box, index) => (
          <div
            key={index}
            className="bg-black border border-gray-300 p-4 rounded-lg shadow-lg flex flex-col items-center justify-center transition-transform transform hover:scale-105 hover:border-cyan-500 max-w-xs mx-auto sm:max-w-sm lg:max-w-md cursor-pointer"
          ...
          <div className="bg-black p-6 rounded-lg max-w-md w-full relative flex flex-col">
            ...
            <div className="space-y-4">
              {boxData[selectedBox].links.map((link, idx) => (
                <a key={idx} href={link} className="bg-cyan-500 text-white py-2 px-4 rounded-lg w-full block text-center" target="_blank" rel="noopener noreferrer">
